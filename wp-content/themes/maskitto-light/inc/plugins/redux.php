            ...
            $this->sections[] = array(
                ...
                'fields'    => array(
                    ...
                    array( 
                        ...
                        'desc'     => '
                            <div class="sh-news-buttons">
                                <a class="button button-primary" href="'.$maskitto_light_support_facebook.'" target="_blank"><i class="el el-facebook"></i>'.__( 'Like Facebook', 'maskitto-light' ).'</a>
                                <a class="button" href="'.$maskitto_light_support_twitter.'" target="_blank"><i class="el el-twitter"></i>'.__( 'Follow Twitter', 'maskitto-light' ).'</a>
                            </div>',
                        'content'  => ''
                    ),
                    ...
                    array( 
                        'id'       => 'opt-raw',
                        'type'     => 'raw',
                        'title'    => __('Documentation', 'maskitto-light'),
                        'desc'     => __('If you are wondering how to setup this theme, then please visit our', 'maskitto-light').' <a href="'.$maskitto_light_documentation.'" target="_blank">'.__( 'documentation guide', 'maskitto-light' ).'</a>.',
                        'content'  => ''
                    ),
                    ...
                    array( 
                        ...
                        'desc'     => __('If you need some help with this theme or you found a bug, then please visit our', 'maskitto-light').' <a href="'.$maskitto_light_support.'" target="_blank">'.__( 'support forum', 'maskitto-light' ).'</a>.',
                        'content'  => ''
                    ),
